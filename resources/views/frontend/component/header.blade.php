            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                ...
                <div class="header-widget uk-flex uk-flex-middle">
                    <div class="header-widget__menu uk-flex uk-flex-middle">
                        <a class="widget_menu__item" href="faq.html">FAQ</a>
                        <a class="widget_menu__item" href="support.html">Support</a>
                        <a class="widget_menu__item" href="contact-us.html">Contact Us</a>
                    </div>
            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                ...
                <div class="header-middle__search">
                    <form action="tim-kiem" class="form-search">
                        <input type="text" name="keyword" value="" placeholder="Entered Your Keyword?">
