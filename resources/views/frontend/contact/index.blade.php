        ...
        <div class="uk-container uk-container-center">
            <div class="mt40 mb40 banner">
                ...
                <div class="text-overlay">
                    <h2 class="heading-1"><span>Contact Us</span></h2>
                    <div class="description">
                        <p>If you have any questions or concerns about the course, please feel free to share them with us.</p>
                    </div>
                </div>
            </div>
            <div class="contact-form">
                <div class="wrapper">
                    <div class="frm-ct">
                        <h3 class="heading-2"><span>Contact Us</span></h3>
                        <p class="des">
                            Please leave your contact information, and within 15–20 minutes, an We representative will reach out to assist you with your inquiries.
                        </p>
                        <form action="{{ url('contact/save') }}" method="POST" class="ct-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="content" name="content" placeholder="We need..." required>
                            </div>
                            <div class="form-group">
                ...
                <div class="uk-grid uk-grid-medium">
                    <div class="uk-width-medium-2-5">
                        <div class="contact-details">
                            ...
                            <h3 class="heading-2"><span>Working hours:</span></h3>
